...
- Correção de overlap do Sticky CTA: esconde automaticamente o botão flutuante ao atingir a seção final de CTA/footer e adiciona padding inferior seguro na página para não cobrir a assinatura do rodapé
