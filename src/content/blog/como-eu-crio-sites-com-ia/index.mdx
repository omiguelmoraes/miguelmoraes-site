...
Primeiro eu extraio o design system real do cliente. Cor, tipografia, espaçamento, borda, componente. Documento numa nota, uma por clube. Parece burocracia até a terceira vez que eu preciso prototipar algo pro mesmo cliente e não preciso extrair nada de novo.
...
Mesmo modelo, mesmo prompt, mesma referência. O que muda é o tamanho do pedaço. Quanto maior o escopo, mais ela preenche com média, e média é exatamente o que faz um site parecer template.
...
O fluxo funciona em qualquer ferramenta, porque ele não é sobre a ferramenta. É sobre onde você coloca a decisão.
...
E teve uma coisa que eu não esperava: esse processo me fez desenhar melhor. Escrever o design system pra IA me obrigou a nomear coisa que eu antes só sentia. Quando você precisa dizer qual é o espaçamento entre seções, descobre se tinha uma regra ou se estava improvisando.
